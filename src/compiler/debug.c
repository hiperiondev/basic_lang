...
static void PrintNodeList(NodeListEntry_t *entry, int indent);
static char* StorageClassName(StorageClass_t storageClass);
static char* TypeName(TypeID_t typeID);
